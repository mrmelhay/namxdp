            ...
            <form class="row" action="{{url('/membership')}}" method="post">
                ...
                <div>
                    ...
                    @endforeach
                        ...
                        <input type="text" name="unionCertfNumber" value="{{old('unionCertfNumber')}}" id="unionCertfNumber" required="required" class="form-control" placeholder="Партия гувохномаа рақами"><br>
                ...
                <div class="submitButton">
                    <a href="{{url('/membership')}}" class="btn btn-default ">Bekor qilish</a>   <button type="submit" class="btn btn-primary ">Saqlash</button>
                </div>
