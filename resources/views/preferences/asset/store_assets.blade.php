...
@section('content')
            ...
            <form action="{{url('/membership')}}" method="post">
                ...
                <select name="nationality_id" data-plugin="select2" required="required" value="{{old('nationality_id')}}" id="nationality" class="form-control">
                ...
                <select class="form-control" value="{{old('region_id')}}" data-plugin="select2" onchange="getDistrict(this)" name="region_id" name="" id="">
                ...
                <select name="district_id" value="{{old('district_id')}}" data-plugin="select2" class="form-control" id="response">
                ...
                <select name="socialPositionId" id="socialPositionId" data-plugin="select2" value="{{old('socialPositionId')}}" required="required" class="form-control">
